...
import { chefInfoById } from './controllers/registration/chefInfoById.mjs';
...
//chefinfoById
app.get('/home/:id/chefinfo',chefInfoById)
...
//forgotPassword
app.patch('/home/LoginPage/forgotPassword',forgotPassword)
